 ...
 */
 ...
 //modified by Dominic Albanese to work with a single tar files that is expanded via http://fhtr.blogspot.com/2010/05/parsing-tarballs-with-javascript.html
...
THREE.Loader.prototype = {
	...
	addStatusElement: function ( ) {
		...
		/* Do not create the small red "Loading ..." box
	...
	createBinModel: function ( data, callback, urlbase, materials , ssJpg ) {
		...
		var Model = function ( urlbase ) {
			...
			THREE.Loader.prototype.init_materials( scope, materials, urlbase , ssJpg);
	...
	init_materials: function( scope, materials, urlbase , ssJpg) {

		scope.materials = [];

		for ( var i = 0; i < materials.length; ++i ) {

			scope.materials[i] = [ THREE.Loader.prototype.createMaterial( materials[i], urlbase , ssJpg ) ];

		}

	},

	createMaterial: function ( m, urlbase , ssJpg ) {
